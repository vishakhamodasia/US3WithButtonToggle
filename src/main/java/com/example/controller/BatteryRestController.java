...
public class BatteryRestController {
	...
	@RequestMapping(path="/battery/{batteryId}/checkBatteryInVL", method=RequestMethod.GET)
	public Response getBatteryStatusInVL(@PathVariable long batteryId,@RequestParam(name = "vendorId") long vendorId){
		VendorList vl=vendorListService.getItem(new VendorList(vendorId,batteryId));
		if(vl!=null) {
			return new Response("Present", "Present");
		}
		else {
			return new Response("Absent", "Absent");
		}
	}
}
